...
public class MarginedRates {
	...
	public MarginedRates() {
	}


	public MarginedRates(Date date, String currencyName, String currencyCode, String terms, double internalSpotRate,
			double buyRate, double sellRate, double bossRate, LocalTime cutOffTime) {
		this.date = date;
